...
let PRESETS = [
  ...
  },
  {
    ...
    "imageUrl": "./images/rings/cartier-love-1d-new.png?v=20260909-7"
  },
  {
    ...
    "imageUrl": "./images/rings/cartier-c-de-cartier-1d.png?v=20260909-7"
  },
  {
    ...
    "imageUrl": "./images/rings/cartier-trinity-cl-new.png?v=20260909-7"
  },
  {
  ...
  },
  {
    ...
    "imageUrl": "./images/rings/bvlgari-bzero1-1d.png"
  },
  {
  ...
  },
  {
    ...
    "imageUrl": "./images/rings/tasaki-trapezio-plain.png?v=20260909-3"
  },
  {
    ...
    "imageUrl": "./images/rings/tasaki-trapezio-1d.png?v=20260909-3"
  },
  {
    "id": "tasaki-piano-3d",
    "brand": "Tasaki",
    ...
    "imageUrl": "./images/rings/tasaki-piano-3d.png?v=20260909-3"
  },
  {
  ...
  },
  {
    ...
    "imageUrl": "./images/rings/chaumet-torsade-1d.png?v=20260909-2"
  },
  {
    ...
    "imageUrl": "./images/rings/chaumet-torsade-pave.png?v=20260909-2"
  },
  {
    ...
    "imageUrl": "./images/rings/chaumet-torsade-plain.png?v=20260909-2"
  },
  {
    ...
    "imageUrl": "./images/rings/chaumet-liens-4mm.png?v=20260909-2"
  },
  {
    ...
    "imageUrl": "./images/rings/chaumet-liens-dia.png?v=20260909-2"
  },
  {
    ...
    "imageUrl": "./images/rings/chaumet-triomphe-sm.png?v=20260909-2"
  },
  {
...
async function loadExternalRingsData() {
  try {
    const res = await fetch('./data/rings.json?v=20260910-12');
...
function applyPreset(preset) {
  ...
  dom.jpGuestCard.disabled = !preset.guestCardAllowed;
  ...
  if (preset.brand === 'Cartier' || preset.brand === 'Chanel' || preset.brand === 'Bvlgari') {
    ...
    dom.guestCardNote.textContent = '부쉐론은 이세탄·미츠코시 백화점에서 5% 적용 가능';
    dom.guestCardNote.style.color = '#357DA6';
  } else if (preset.brand === 'Tasaki') {
    dom.guestCardNote.textContent = '타사키는 매장별 적용 여부가 달라 구매 전 확인 필요';
    dom.guestCardNote.style.color = '#357DA6';
  } else {
    dom.guestCardNote.textContent = `${preset.brandKr || preset.brand}는 백화점·지점별 5% 적용 여부 확인 필요`;
    dom.guestCardNote.style.color = '#357DA6';
  }
